    ...
    <section className="relative w-full h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto flex flex-col items-center">
        ...
        <p className="text-lg md:text-xl text-[#F4F4F4] mb-8 max-w-2xl font-inter">
          Únete a nuestro gimnasio y transforma tu vida. Ofrecemos atención personalizada, clases grupales y los mejores planes mensuales con equipamiento de primer nivel.
        </p>
